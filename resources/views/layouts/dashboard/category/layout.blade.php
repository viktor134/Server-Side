...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="/dashboard/assets/font-awesome/4.5.0/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="/dashboard/assets/ionicons/2.0.1/css/ionicons.min.css">
  <!-- DataTables -->
...
<!-- jQuery 2.2.3 -->
<script src="/dashboard/assets/plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.6 -->
<script src="/dashboard/assets/bootstrap/js/bootstrap.min.js"></script>
<!-- DataTables -->
<script src="/dashboard/assets/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="/dashboard/assets/plugins/datatables/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
<script src="/dashboard/assets/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="/dashboard/assets/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="/dashboard/assets/dist/js/app.min.js"></script>
